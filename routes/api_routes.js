...
const { createPost, getAllPosts, getSinglePost, getPostByCategory, deletePostById,  singlePostDetail } = require('../controller/post_controller')
...
apiRouter.get("/single/:id", singlePostDetail)
